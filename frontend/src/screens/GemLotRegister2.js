    ...
    <View style={[baseScreenStyles.container, styles.container]}>
      ...
      <View style={styles.innerContainer}>
        ...
        <Picker
          ...
          onValueChange={(itemValue) => handleInputChange('gemType', itemValue)}
          style={form.gemType === "" ? styles.placeholder : styles.picker}
        >
          <Picker.Item
          label="Gem Type"
          value=""
          style={form.gemType.value === "" ? styles.placeholder : styles.picker} // Apply special style only to placeholder
        />
